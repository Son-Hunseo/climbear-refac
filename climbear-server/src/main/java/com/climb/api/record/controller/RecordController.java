...
public class RecordController {
    ...
    @PostMapping()
    public ResponseEntity<CustomApiResponse<MessageResponse>> saveMemberRoute(@RequestHeader("X-USER-ID") Integer userId,
                                                                              @RequestBody SaveSuccessRouteRequestDTO requestDTO){
    ...
    public ResponseEntity<CustomApiResponse<MessageResponse>> failRecord(@RequestHeader("X-USER-ID") Integer userId,
    ...
    @GetMapping("/list")
    public ResponseEntity<CustomApiResponse<List<GetMyRecordListResponseDTO>>> getMyRecordList(@RequestHeader("X-USER-ID") Integer userId){
    ...
    public ResponseEntity<CustomApiResponse<List<GetSimilarRecordListResponseDTO>>> getSimilarRecordList(@RequestHeader("X-USER-ID") Integer userId,
                                                                                                         @PathVariable("categoryId") @Valid int categoryId){
